...
function initGUI() {
  ...
  gui.add( effectController, 'minDistance', 10, 500 );
...
function animate() {
  ...
  effectController.minDistance += vel ;

  if(effectController.minDistance > 500 ) vel *= -1;
  if (effectController.minDistance < 200) vel *= -1;
